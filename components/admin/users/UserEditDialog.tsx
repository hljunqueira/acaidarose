...
export default function UserEditDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] sm:w-full max-w-md max-h-[90vh] overflow-y-auto p-4 sm:p-6 bg-white dark:bg-[#160228] border border-purple-150 dark:border-white/20 text-slate-900 dark:text-white rounded-3xl shadow-2xl">
