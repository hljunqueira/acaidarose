    ...
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 pb-3 border-b border-purple-100">
        ...
        <Button
          ...
          onClick={handleSave}
          disabled={saving}
          className="h-8.5 bg-purple-700 hover:bg-purple-800 text-white text-xs font-bold rounded-xl shadow-xs"
        >
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <Card className="p-5 rounded-3xl border border-purple-100 bg-white space-y-4 shadow-xs">
          <div className="text-xs font-black text-purple-950 uppercase tracking-wider border-b border-purple-50 pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">NIF (Portugal):</Label>
              <Input
                value={form.nif || ''}
            ...
            <div className="space-y-1.5 md:col-span-3">
              <Label className="text-xs font-bold text-foreground">Razão Social / Entidade Jurídica:</Label>
              <Input
        ...
        <Card className="p-5 rounded-3xl border border-purple-100 bg-white space-y-4 shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1.5 md:col-span-2">
              <Label className="text-xs font-bold text-foreground">Morada Completa:</Label>
              <Input
                value={form.address || ''}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">Código Postal & Cidade:</Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">Telemóvel Geral:</Label>
              <Input
                value={form.phone || ''}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-purple-950">Telemóvel MB Way (Recebimento):</Label>
              <Input
                value={form.mbwayPhone || ''}
                onChange={(e) => setForm({ ...form, mbwayPhone: e.target.value })}
                placeholder="+351 911 050 264"
                className="h-10 text-xs rounded-xl font-mono font-bold border-purple-300 bg-purple-50/40"
              />
            </div>

            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">Instagram Oficial:</Label>
              <Input
        ...
        <Card className="p-5 rounded-3xl border border-purple-100 bg-white space-y-4 shadow-xs">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">Nome da Rede Wi-Fi (SSID):</Label>
              <Input
            ...
            <div className="space-y-1.5">
              <Label className="text-xs font-bold text-foreground">Palavra-passe do Wi-Fi:</Label>
              <Input
            ...
            <div className="space-y-1.5 md:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-3 rounded-xl border border-input text-xs bg-background focus:outline-hidden focus:ring-2 focus:ring-purple-600"
              />
            </div>
          </div>
        </Card>
            ...
            {daysList.map((day) => {
              ...
              return (
                <div key={day.key} className="py-2.5 flex items-center justify-between gap-4 text-xs">
                  <span className="font-bold text-foreground w-28">{day.label}</span>

                  <div className="flex items-center gap-2">
                    <span className="text-muted-foreground text-[11px]">Abertura:</span>
                    <Input
                      type="time"
                    ...
                    <span className="text-muted-foreground text-[11px]">Encerramento:</span>
                    <Input
                      type="time"
